        ...
        <div className="fixed bottom-0 right-0">
                {
                    state.theme === "light"
                    ?
                    <button onClick={() => dispatch({ type: "SWITCH_THEME", payload: "dark" })} className="m-5 border rounded-full p-3">
                    ...
                    :
                    <button onClick={() => dispatch({ type: "SWITCH_THEME", payload: "light" })} className="m-5 border rounded-full p-3">
